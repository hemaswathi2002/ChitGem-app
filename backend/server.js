...
app.get('/api/chitIds/notPaidForMonth',authenticateUser,authorizeUser(['owner']),paymentsCntrl.chitsNotPaid)
app.put('/api/status/update/:id',paymentsCntrl.failureUpdate)
app.listen(port,()=>{
